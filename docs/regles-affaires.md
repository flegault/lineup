...
- À la création ou à la réinitialisation d’un match, tous les réguliers actifs sont présents.
...
- Au moins huit patineurs sont requis pour viser deux défenseurs et deux attaquants par équipe.
...
## Importation, exportation et réinitialisation
...
- Réinitialiser le bassin supprime les joueurs et vide les présences et équipes courantes, mais conserve l’historique, les noms d’équipe et les préférences.
